...
GlassPanel {
    ...
    RowLayout {
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    height: 24
                    radius: 5
                    color: trayMouse.containsMouse ? Theme.stateAccentHover : "transparent"
        ...
        Rectangle {
            ...
            radius: 6
            color: PopupService.notificationMenuOpen ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.2) : (notifMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            // icons next to it.
            BellIcon {
                color: notifMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
                implicitWidth: 16
                implicitHeight: 16
        ...
        Rectangle {
            ...
            Layout.preferredHeight: Theme.barCapsule
            radius: 6
            color: PopupService.captureMenuOpen ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.2) : (captureMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            UiIcon {
                color: captureMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
                name: "camera"
                implicitWidth: 16
                implicitHeight: 16
        ...
        Rectangle {
            ...
            Layout.preferredHeight: Theme.barCapsule
            radius: 6
            color: PopupService.clipboardMenuOpen ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.2) : (clipMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            UiIcon {
                color: clipMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
                name: "clipboard-list"
                implicitWidth: 16
                implicitHeight: 16
        ...
        Rectangle {
            ...
            Layout.preferredHeight: Theme.barCapsule
            radius: 6
            color: PopupService.audioMenuOpen ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.2) : (audioMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            VolumeIcon {
                color: audioMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
        ...
        Rectangle {
            ...
            color: PopupService.bluetoothMenuOpen
                   ? Theme.stateActive
                   : (btMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            BluetoothIcon {
                color: btMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
        ...
        Rectangle {
            ...
            color: PopupService.brightnessMenuOpen
                   ? Theme.stateActive
                   : (brightMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            BrightnessIcon {
                color: brightMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
        ...
        Rectangle {
            ...
            color: PopupService.mountMenuOpen
                   ? Theme.stateActive
                   : (mountMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            UiIcon {
                color: mountMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
                name: "hard-drive"
                implicitWidth: 16
                implicitHeight: 16
        ...
        Rectangle {
            ...
            color: PopupService.networkMenuOpen
                   ? Theme.stateActive
                   : (netMouse.containsMouse ? Theme.stateAccentHover : "transparent")
            ...
            NetworkIcon {
                color: netMouse.containsMouse ? Theme.accent : Theme.fg
                anchors.centerIn: parent
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        radius: 5
                        color: regShotMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 28
                        radius: 5
                        color: fullShotMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                        border.color: Theme.currentLine
                        border.width: 1
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 28
                        radius: 5
                        color: winShotMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                        border.color: Theme.currentLine
                        border.width: 1
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 28
                        radius: 5
                        color: regRecMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                        border.color: Theme.currentLine
                        border.width: 1
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 28
                        radius: 5
                        color: fullRecMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                        border.color: Theme.currentLine
                        border.width: 1
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: 28
                    radius: 5
                    color: guiBtnMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                radius: 6
                                color: clipItemMouse.containsMouse ? Theme.stateAccentHover : Theme.surface
                                border.color: Theme.currentLine
                                border.width: 1
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        width: 20; height: 20; radius: 4
                        color: refreshBtMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                        UiIcon {
                            anchors.centerIn: parent
                            name: "refresh-cw"
                            implicitWidth: 15
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            color: disconnMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                                            border.color: Theme.red
                                            border.width: 1
                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                ...
                                Rectangle {
                                    ...
                                    Layout.preferredHeight: 28
                                    radius: 5
                                    color: btDevMouse.containsMouse ? Theme.stateAccentHover : "transparent"
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: Theme.barCapsule
                    radius: 5
                    color: muteBtnMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                    border.color: Theme.currentLine
                    border.width: 1
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        width: 20; height: 20; radius: 4
                        color: refreshBrightMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                        UiIcon {
                            anchors.centerIn: parent
                            name: "refresh-cw"
                            implicitWidth: 15
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        width: 20; height: 20; radius: 4
                        color: refreshMountMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                        UiIcon {
                            anchors.centerIn: parent
                            name: "refresh-cw"
                            implicitWidth: 15
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            radius: 4
                                            color: mntBtnMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                                            border.color: Theme.currentLine
                                            border.width: 1
                                        ...
                                        Rectangle {
                                            ...
                                            Layout.preferredHeight: 22
                                            radius: 4
                                            color: openBtnMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08))
                                            border.color: Theme.currentLine
                                            border.width: 1
                                        ...
                                        Rectangle {
                                            ...
                                            color: autoOn ? Qt.rgba(80/255, 250/255, 123/255, 0.2) : (autoBtnMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08)))
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        width: 20; height: 20; radius: 4
                        color: refreshNetMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                        UiIcon {
                            anchors.centerIn: parent
                            name: "refresh-cw"
                            implicitWidth: 15
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                Layout.preferredHeight: Theme.barCapsule
                                radius: 5
                                color: modelData.inUse ? Qt.rgba(Theme.accent.r, Theme.accent.g, Theme.accent.b, 0.18) : (netItemMouse.containsMouse ? Theme.stateAccentHover : "transparent")
        ...
        GlassPanel {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 6
                    color: BatteryService.isSleepBlocked ? Qt.rgba(255/255, 184/255, 108/255, 0.2) : (sleepMouse.containsMouse ? Theme.stateAccentHover : (Theme.isDark ? Theme.currentLine : Qt.rgba(Theme.fg.r, Theme.fg.g, Theme.fg.b, 0.08)))
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 22
                        radius: 4
                        color: openActMouse.containsMouse ? Theme.stateAccentHover : "transparent"
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: 22
                        radius: 4
                        color: secondaryActMouse.containsMouse ? Theme.stateAccentHover : "transparent"
