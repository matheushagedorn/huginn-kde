...
Item {
    ...
    Process {
        ...
        command: ["bash", "-c", "QDBUS=$(command -v qdbus6 || command -v qdbus); $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.unloadEffect overview 2>/dev/null; $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.unloadEffect grid 2>/dev/null; $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.unloadEffect presentwindows 2>/dev/null"]
        onExited: running = false
    }

    Process {
        id: enableEffectsProc
        command: ["bash", "-c", "QDBUS=$(command -v qdbus6 || command -v qdbus); $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.loadEffect overview 2>/dev/null; $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.loadEffect grid 2>/dev/null; $QDBUS org.kde.KWin /Effects org.kde.kwin.Effects.loadEffect presentwindows 2>/dev/null"]
        onExited: running = false
    }
    ...
    function submitPassword() {
        ...
        authProc.command = ["python3", Quickshell.env("HOME") + "/.config/huginn/services/python/lockscreen_auth_service.py", userPassword]
