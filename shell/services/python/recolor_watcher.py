...
def get_palette(variant_name):
    ...
    theme_qml = os.path.expanduser('~/.config/huginn/theme/Theme.qml')
    if not os.path.exists(theme_qml):
        theme_qml = os.path.expanduser('~/Documents/themes/shell/theme/Theme.qml')
...
def watch_folder():
    base_dirs = [
        ...
        os.path.expanduser('~/.config/huginn/wallpapers'),
        os.path.expanduser('~/Documents/themes/shell/wallpapers')
    ]
    processed = set()
