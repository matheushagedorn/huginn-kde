...
Item {
    ...
    Process {
        id: monitorProc
        command: ["python3", "-u", Quickshell.env("HOME") + "/.config/huginn/services/python/system_monitor_service.py"]
        running: true
        stdout: SplitParser {
            onRead: data => {
                try {
                    ...
                    if (parsed && typeof parsed === "object") {
                        ...
                        if (parsed.disk_name !== undefined) root.diskName = parsed.disk_name
