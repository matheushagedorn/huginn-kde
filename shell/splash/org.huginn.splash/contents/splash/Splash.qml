...
Item {
    ...
    property color bgColor: "#16171c"
    property color surfaceColor: "#23242b"
    property color fgColor: "#ebedf7"
    property color accentColor: "#6d7ec7"
    property color subAccentColor: "#9f72c7"
    property string themeName: "From wallpaper"
